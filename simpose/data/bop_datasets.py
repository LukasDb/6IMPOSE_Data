...
class HOPE(_BOPBase):
    ...
    _urls = [
        "https://bop.felk.cvut.cz/media/data/bop_datasets/hope_base.zip",
        "https://bop.felk.cvut.cz/media/data/bop_datasets/hope_models.zip",
        "https://bop.felk.cvut.cz/media/data/bop_datasets/hope_val.zip",
    ]
