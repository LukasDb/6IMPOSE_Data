...
class Placeable:
    ...
    def set_location(self, location: tuple | np.ndarray) -> None:
        import mathutils
    ...
    def point_at(self, location: np.ndarray) -> None:
    ...
    def apply_global_offset(self, offset: tuple | np.ndarray) -> None:
    ...
    def apply_local_offset(self, offset: tuple | np.ndarray) -> None:
        """Apply offset to location."""
        import mathutils
        if isinstance(offset, np.ndarray):
            offset = tuple(offset)
    ...
    def apply_global_rotation_offset(self, rotation: R) -> None:
        """Apply offset to rotation."""
        self.set_rotation(rotation * self.rotation)

    def apply_local_rotation_offset(self, rotation: R) -> None:
        """Apply offset to rotation."""
